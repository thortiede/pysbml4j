...
class PathwayInventoryItem(object):
    ...
    def __init__(self, uuid=None, name=None, pathway_id=None, organism_code=None, number_of_nodes=None, number_of_transitions=None, number_of_reactions=None, node_types=None, transition_types=None, compartments=None):  # noqa: E501
